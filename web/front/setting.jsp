...
<div class="bar bar-header bar-positive">
    ...
    <div class="h1 title"><b>用户设置</b></div>
</div>
...
<div class="content has-header ionic-pseudo">
    ...
    <ion-scroll zooming="true" direction="xy" style="width: 100%; height: 86%">
        <div class="list list-inset">
            ...
            <a class="item item-icon-left" href="${pageContext.request.contextPath}/front/changePassword.jsp">
                <i class="icon ion-edit"></i>
                修改登录密码
            </a>

            <a class="item item-icon-left" href="${pageContext.request.contextPath}/front/changePic.jsp">
                <i class="icon ion-person"></i>
                修改头像
            </a>

            <a class="item item-icon-left" href="${pageContext.request.contextPath}/front/changePhone.jsp">
                <i class="icon ion-iphone"></i>
                修改通讯信息
            </a>

            <a class="item item-icon-left" href="${pageContext.request.contextPath}/front/sendSuggest.jsp">
            ...
            <a  class="item item-assertive text-center" href="${pageContext.request.contextPath}/ExitLoginServlet">
                退出登录
            </a>
