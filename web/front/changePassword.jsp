...
<div class="bar bar-header bar-positive">
    ...
    <div class="h1 title"><b>修改登录密码</b></div>
</div>
...
<div class="content has-header ionic-pseudo">
    ...
    <form method="post" action="${pageContext.request.contextPath}/updateUserPasswordServlet">
        <div class="list list-inset">
            ...
            <label class="item item-input item-stacked-label">
                <span class="input-label">再次输入新密码</span>
                <input type="password" placeholder="再次输入..." name="verifypassword">
            </label>
